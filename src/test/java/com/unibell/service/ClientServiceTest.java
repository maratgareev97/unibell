...
public class ClientServiceTest {
    ...
    public void testAddClient() {
        ...
        client.setId(1L);
        client.setName("Гареев Марат");

        when(clientRepository.save(any(Client.class))).thenReturn(client);

        ClientDTO clientDTO = clientService.addClient("Гареев Марат");

        assertNotNull(clientDTO);
        assertEquals("Гареев Марат", clientDTO.getName());
    ...
    public void testAddSingleContact() {
        ...
        contactsInfo.setPhones(List.of("123-456-7890"));
    ...
    public void testAddMultipleContacts() {
        ...
        List<String> phones = List.of("123-456-7890", "098-765-4321");
        List<String> emails = List.of("marat@g.com", "ivan@g.com");
